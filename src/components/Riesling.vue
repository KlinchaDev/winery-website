    ...
    <div class="wine-card">
      ...
      <div class="wine-left fade-in">
        <div class="splash-container">
          ...
          <img src="/images/riesling.png" alt="Riesling Wine Bottle" class="bottle" />
        </div>
      </div>
      ...
      <div class="wine-right fade-up">
        <div class="info-box">
          <h1 class="wine-title">Riesling</h1>

          <p class="subtitle">White Aromatic Wine · 2023 Vintage</p>
          <hr class="divider" />

          <p class="story">
            Crafted from premium <strong>Riesling grapes</strong>, this elegant wine
            reflects the freshness of the <span class="highlight">Tikveš wine region</span>.
            It reveals notes of lime, green apple, and white peach, with a crisp,
            aromatic, and refined finish.
          </p>
